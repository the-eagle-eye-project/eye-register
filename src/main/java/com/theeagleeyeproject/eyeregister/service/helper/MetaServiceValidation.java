...
public class MetaServiceValidation {
    ...
    private void validateRelatedIntegrations(@NotNull List<RelatedIntegrationId> relatedIntegration) {
        relatedIntegration
                .forEach(integration -> {
                    if (eyeRegistryRepository.findByIntegrationId(integration.getRelatedIntegrationId()) == null) {
